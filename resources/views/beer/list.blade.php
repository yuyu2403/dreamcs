                ...
                document.addEventListener("DOMContentLoaded", function () {
                    ...
                    carouselControlPrev.addEventListener("click", function () {
                        carouselItems.forEach(function (item) {
                            item.classList.add("carousel-item-left");
                            item.classList.remove("carousel-item-next", "carousel-item-prev", "carousel-item-right");
                        });
                    });

                    carouselControlNext.addEventListener("click", function () {
                        carouselItems.forEach(function (item) {
                            item.classList.add("carousel-item-right");
                            item.classList.remove("carousel-item-next", "carousel-item-prev", "carousel-item-left");
                        });
                    });
                });
            </script>
        ...
        <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item">
                        <img src='images/jyugon.jpg' class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item">
